...
const svgs =[
    {dotsvg: { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }}
]

const ammo919datas = [
    { id: '9x19mm AP 6.3', damage: 52, penetration: 30, armordmg: 8, accuracy: 0, recoil: 0, fragmentchance: 5, ricochet: 20, lightbleed: 0, heavybleed: 0, projectilespeed: 392, special: 'none' ,dotsvg: { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }},
