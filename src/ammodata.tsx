export function getAmmodata(ids: string[]) {
    ...
    ids.forEach(id => {
        if (ammoMap.has(id)) {
            tmparr.push(...ammoMap.get(id)!)
        }
    });
    return (tmparr);
};

type AmmoDataEntryPre = {
    id: string;//id
    damage: number;
    penetration: number;
    armordmg: number;
...
export type AmmoDataEntry = AmmoDataEntryPre & {
    dotsvg?: SVG;
}
...
register('9*19', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
    ...
    { id: '9x19mm PBP gzh', damage: 52, penetration: 39, armordmg: 3, accuracy: 15, recoil: 15, fragmentchance: 5, ricochet: 20, lightbleed: 0, heavybleed: 0, projectilespeed: 560, special: 'none', image: 'src/assets/image/9*19/9x19ap.png' },
    { id: '9x19mm PSO gzh', damage: 59, penetration: 10, armordmg: 2, accuracy: 0, recoil: 0, fragmentchance: 25, ricochet: 6.50, lightbleed: 0, heavybleed: 0, projectilespeed: 340, special: 'Subsonic', image: 'src/assets/image/9*19/9x19ap.png' },
    { id: '9x19mm Pst gzh', damage: 54, penetration: 20, armordmg: 3, accuracy: 0, recoil: 0, fragmentchance: 15, ricochet: 5, lightbleed: 0, heavybleed: 0, projectilespeed: 457, special: 'none', image: 'src/assets/image/9*19/9x19ap.png' },
    { id: '9x19mm QuakeMaker', damage: 85, penetration: 8, armordmg: 2, accuracy: 10, recoil: 10, fragmentchance: 10, ricochet: 10, lightbleed: 15, heavybleed: 22, projectilespeed: 290, special: 'Subsonic', image: 'src/assets/image/9*19/9x19ap.png' },
    { id: '9x19mm RIP', damage: 102, penetration: 2, armordmg: 1, accuracy: 0, recoil: 20, fragmentchance: 100, ricochet: 0.20, lightbleed: 30, heavybleed: 10, projectilespeed: 381, special: 'none', image: 'src/assets/image/9*19/9x19ap.png' }
])
register('9*18', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('9*21', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('45acp', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('7.62*25', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('5.7*28', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('4.6*30', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('357magnum', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('5.45*39', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('7.62*39', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('5.56*45', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('7.62*51', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('7.62*54r', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('366tkm', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('300blackout', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('9*39', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('12.7*55', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('338lapua', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('12gauge', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('20gauge', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
...
register('8gauge', { shape: 'M19 6L6 19M6 6l13 13', color: '#fff', width: 2 }, [
